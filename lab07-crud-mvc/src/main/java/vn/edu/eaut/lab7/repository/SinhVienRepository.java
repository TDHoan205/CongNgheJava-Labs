...
public class SinhVienRepository {
    ...
    static {
        ...
        data.add(new SinhVien(5, "20240005", "Hoàng Văn Em", "em@gmail.com", "DCCNTT15.10.1"));
        data.add(new SinhVien(6, "20240006", "Vũ Thị Giang", "giang@gmail.com", "DCCNTT15.10.3"));
        data.add(new SinhVien(7, "20240007", "Đỗ Văn Hoa", "hoa@gmail.com", "DCCNTT15.10.3"));
    }
