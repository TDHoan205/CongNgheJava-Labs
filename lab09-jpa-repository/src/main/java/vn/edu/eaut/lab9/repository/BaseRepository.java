...
/**
 * Generic BaseRepository implementation using JPA EntityManager and RESOURCE_LOCAL EntityTransaction.
 * Provides standard CRUD and pagination operations for all domain entities.
 */
