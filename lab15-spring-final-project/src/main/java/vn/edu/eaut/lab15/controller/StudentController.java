...
public class StudentController {
    ...
    public String save(@Valid @ModelAttribute("student") Student student,
        ...
        if (student.getStudentCode() != null && !student.getStudentCode().trim().isEmpty()) {
            if (studentService.isStudentCodeExists(student.getStudentCode(), student.getId())) {
                result.rejectValue("studentCode", "error.studentCode", "Mã sinh viên '" + student.getStudentCode() + "' đã tồn tại!");
            }
        }
        ...
        redirectAttributes.addFlashAttribute("successMessage", isNew ? "Thêm mới sinh viên '" + student.getFullName() + "' thành công!" : "Cập nhật thông tin sinh viên '" + student.getFullName() + "' thành công!");
    ...
    public String detail(@PathVariable("id") Long id, Model model) {
        try {
            ...
            // Bài 8: Lấy danh sách các môn học mà sinh viên này đã đăng ký
    ...
    public String delete(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage", "Đã xóa sinh viên '" + student.getFullName() + "' thành công!");
        } catch (Exception e) {
